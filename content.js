      ...
      function() {
        ...
        if(typeof(curentnum) == "undefined" || num != curentnum){    
         ...
         (async() => {
          ...
          var plg_ohhe = await getLocalStorageValue('plg_on_hover_history_enable');
          if(plg_ohhe.plg_on_hover_history_enable == true){
            ...
            var url = "http://ppoz-service-bal-01.prod.egrn:9001/manager/assign/users/history?requestId=".concat(statement_number);
            console.log(url);
...
setInterval(function(){
  if(document.webkitVisibilityState == 'visible'){
    ...
    //if (curentpodr!=JSON.stringify(podrazc)){
      ...
      //if(podrazc.length>0){
        //console.log(podrazc);
        chrome.runtime.sendMessage({region: regionc, podrazdelenie: podrazc}/*, function(response){      
